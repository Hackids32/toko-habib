...
class barangKeluar_model extends ci_model{
    ...
    public function dataJoin()
    {
      ...
      $this->db->join('reseller as res', 'res.id_reseller = bk.id_reseller');
      $this->db->join('jenis as j', 'j.id_jenis = bk.id_jenis');
      $this->db->join('satuan as s', 's.id_satuan = bk.id_satuan');
    ...
    function lapdata($tglAwal, $tglAkhir)
    {
      ...
      $this->db->from('barang_keluar as bk');
      $this->db->join('barang as b', 'b.id_barang = bk.id_barang');
      $this->db->join('reseller as r', 'r.id_reseller = bk.id_reseller');
