...
class pesan_barang_model extends ci_model
{
  ...
  function data()
  {
    ...
    return  $this->db->query("SELECT * FROM pesanbarang WHERE verifikasi=''");
  }

  public function dataJoin()
  {
    $this->db->select('*');
    $this->db->from('pesanbarang as b');
    $this->db->join('barang as c', 'c.id_barang = b.id_barang');
    $this->db->join('jenis as j', 'j.id_jenis = c.id_jenis');
    $this->db->join('satuan as s', 's.id_satuan = c.id_satuan');
