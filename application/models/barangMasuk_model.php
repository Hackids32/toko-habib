...
class barangMasuk_model extends ci_model{
    ...
    public function dataJoin()
    {
      ...
      $this->db->join('supplier as sp', 'sp.id_supplier = bm.id_supplier');
      $this->db->join('jenis as j', 'j.id_jenis = bm.id_jenis');
      $this->db->join('satuan as s', 's.id_satuan = bm.id_satuan');
