...
class Home extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['barang'] = $this->barang_model->stokTipis()->result();
		$data['baranglaris'] = $this->barang_model->terlaris()->result();
		$data['jmlbarang'] = $this->barang_model->dataJoin()->num_rows();
		$data['jmlsupplier'] = $this->supplier_model->data()->num_rows();
		$data['jmlres'] = $this->reseller_model->data()->num_rows();
		$data['jmlUser'] = $this->user_model->data()->num_rows();
		$data['datapesanbarang'] = $this->pesan_barang_model->data()->num_rows();
