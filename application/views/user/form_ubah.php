                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Level</label>
                                <select name="level" class="form-control">
                                    ...
                                    <option value="owner" 
                                    <?php if($u->level == "owner"): ?> Selected <?php endif; ?> >Owner</option>
                                    <option value="karyawan" 
                                    <?php if($u->level == "karyawan"): ?> Selected <?php endif; ?> >Karyawan Toko</option>
                                    <option value="reseller" 
                                    <?php if($u->level == "reseller"): ?> Selected <?php endif; ?> >Re-Seller</option>
                                </select>
                                    </div>
                        </div>
