...
<div class="container-fluid">
    ...
    <form action="<?= base_url() ?>barangKeluar/proses_tambah" name="myForm" method="POST" enctype="multipart/form-data"
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="card-body">
                        <div class="col-lg-20">
                            ...
                            <div class="form-group"><label>Tanggal Keluar</label>
                                <input class="form-control" name="tgl_keluar" type="date" placeholder="">
                            </div>
                            <!-- Pengirim -->
                            <div class="form-group"><label>Penerima</label>
                            <select name="reseller" class="form-control chosen">
                                    <option value=""></option>
                                    <?php foreach($reseller as $res): ?>
                                    <option value="<?= $res->id_reseller ?>"><?= $res->nama_reseller ?></option>
                                    <?php endforeach ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group"><label>Satuan Barang</label>
                            ...
                            <div class="form-group"><label>Harga Satuan</label>
                                <input class="form-control" name="harga_kel" type="number" placeholder="" onkeypress="return angka(event)">
                            </div>


                            <!-- Stok -->
                            <div class="form-group"><label>Jumlah</label>
                                <input class="form-control" name="jumlah_keluar" type="number" placeholder="" onkeypress="return angka(event)">
                            </div>                            
                    </div>
                    <br>
                </div>
            ...
            <a href="<?= base_url() ?>barang_keluar" class="btn btn-md btn-primary">Kembali</a>
...
<?php else: ?>
    <script>
        async function tes() {
            ...
            let getDetail = await fetch(`/toko_habib/barangKeluar/getDetail/${barang}`)
                .then(r => r.text())
                .then(d => {
                    return d;
                })
